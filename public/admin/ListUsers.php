                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"><?= format_cash($LQH->num_rows("SELECT * FROM `users`")) ?> thành viên</span>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"><?= format_cash($LQH->get_row("SELECT SUM(`money`) FROM `users` ")['SUM(`money`)']); ?>đ</span>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">Admin: <?= format_cash($LQH->num_rows("SELECT * FROM `users` WHERE `level`='admin'")) ?></span>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"> <?= format_cash($LQH->num_rows("SELECT * FROM `users` WHERE `banned`='1'")) ?> tài khoản</span>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive p-0">
                                <table id="datatable1" class="table table-bordered table-striped table-hover">
                                    ...
                                    <tbody>
                                        <?php $i = 0;
                                        foreach ($LQH->get_list("SELECT * FROM `users` ORDER BY `id` DESC") as $row) { ?>
                                            <tr>
                                                <td><?= $i++ ?></td>
                                                <td>
                                                    <ul>
                                                        ...
                                                        <li>Tình trạng: <span class="badge badge-success"><?= display_banned($row['banned']) ?></span>
                                                        </li>
                                                    </ul>
                                                </td>
                                                <td>
                                                    <ul>
                                                        <li>Số dư khả dụng: <b style="color:blue"><?= format_cash($row['money']) ?>đ</b>
                                                        </li>
                                                        <li>Tổng số tiền nạp: <b style="color:red"><?= format_cash($row['total_money']) ?>đ</b>
                                                        </li>
                                                    </ul>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <a aria-label="" href="<?= BASE_URL('/admin/ListUsers/Edit/') ?><?= $row['id'] ?>" style="color:white;" class="btn btn-info btn-sm btn-icon-left m-b-10" type="button">
