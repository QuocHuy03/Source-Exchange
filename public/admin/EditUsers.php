...
<?php
if (isset($_GET['id'])) {
    $row = $LQH->get_row(" SELECT * FROM `users` WHERE `id` = '" . check_string($_GET['id']) . "'  ");
    if (!$row) {
    }
} else {
}
if (isset($_POST['Save'])) {
    $isInsert = $LQH->update("users", array(
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="username" value="<?= $row['username'] ?>" placeholder="Nhập tài khoản" required>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Email</label>
                                <input type="email" class="form-control" name="email" value="<?= $row['email'] ?>" placeholder="Nhập tài khoản" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="<?= $row['level'] ?>" name="admin" placeholder="Nếu muốn admin thì nhập: admin" required>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive p-0">
                            <table id="datatable1" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    <?php $i = 1;
                                    foreach ($LQH->get_list("SELECT * FROM `log_balance` WHERE `user_id`='" . $row['id'] . "' ORDER BY `id` DESC") as $row) { ?>
                                        <tr>
                                            <td><?= $i++ ?></td>
                    ...
                    <div class="card-body">
                        <div class="table-responsive p-0">
                            <table id="datatable2" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    <?php $i = 1;
                                    foreach ($LQH->get_list("SELECT * FROM `logs` WHERE `user_id`='" . $row['id'] . "' ORDER BY `id` DESC") as $row) { ?>
                                        <tr>
                                            <td><?= $i++ ?></td>
